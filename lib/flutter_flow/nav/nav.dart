...
class AppStateNotifier extends ChangeNotifier {
  SeriusFirebaseUser? initialUser;
  SeriusFirebaseUser? user;
  ...
  void update(SeriusFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
            ...
            FFRoute(
              ...
              builder: (context, params) => EditProfileWidget(
                ...
                userPhoto: params.getParam(
                    'userPhoto', ParamType.DocumentReference, 'users'),
              ),
            ),
            FFRoute(
              name: 'screens',
              path: 'screens',
              builder: (context, params) => ScreensWidget(),
            ),
            FFRoute(
              name: 'post',
              path: 'post',
